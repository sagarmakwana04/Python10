...
exceptions can be handled but errors cant be handled if syntax error is given then we have to fix it any how other wise code will not run 
...
a = marks / 0
print(a)
# In the above example raised the ZeroDivisionError as we are trying to divide a number by 0. is type of exception
